...
<body>
  ...
  <hr />
  <form:form action="saveUser" method="post" modelAttribute="user"><p align="center">
    </p><table style="color: Blue; background-color: Aqua; word-spacing: normal; text-decoration: blink">
      <tr>
        <th>Name</th>
        <td>
